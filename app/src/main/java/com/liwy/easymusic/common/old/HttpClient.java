...
import com.liwy.easymusic.model.ArtistInfo;
import com.liwy.easymusic.model.DownloadInfo;
import com.liwy.easymusic.model.Lrc;
import com.liwy.easymusic.model.OnlineMusicList;
import com.liwy.easymusic.model.SearchMusic;
...
//    }
    ...
    public static void downloadFile(String url, String destFileDir, String destFileName, final HttpCallback<File> callback) {
        OkHttpUtils.get().url(url).addHeader("user-agent", "Mozilla/5.0 (Windows; U; Windows NT 5.1; en-US; rv:0.9.4)").build()
